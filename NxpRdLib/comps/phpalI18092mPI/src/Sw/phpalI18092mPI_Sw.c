...
* 
***************************************************************/
phStatus_t phpalI18092mPI_Sw_Detect(
                                     phpalI18092mPI_Sw_DataParams_t * pDataParams
                                     ...
                                     )
{
    ...
    do {
        ...
        /* Write frame header and update length field. */
        PH_CHECK_SUCCESS_FCT(statusTmp, phpalI18092mPI_Sw_WriteFrameHeader(pDataParams,PH_EXCHANGE_BUFFER_FIRST, 0x06, bCmdLen));
