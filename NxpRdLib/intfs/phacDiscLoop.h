 ...
 */
#ifdef NXPBUILD__PHAC_DISCLOOP_TYPEA_TAGS//A类标签
    typedef struct phacDiscLoop_TypeA_Tags {
        uint8_t  bTotalTagsFound_A;  //发现A卡片的数量                                            /**< Number of type A tags found */ 
        uint8_t  bActivatedTagNumber_A; //A卡激活的数量，如果存在多个A卡，只能激活一张 ,进入14443-4或者18092           
        ...
        struct phacDiscLoop_TypeA_I3P3 {//符合ISO14443-3A的卡片，包括S50 S70 UL卡片
            ...
            uint8_t bTagState;              //卡片是否卡片激活（符合14443-4或者18092的激活流程）
        ...
        struct phascDiscLoop_TypeA_I3P4 {//符合ISO14443-4A的卡片
        ...
        struct phacDiscLoop_Type_P2P_TAGS {//符合ISO-18092 106KPBS的卡片
...
/*B类标签*/
    typedef struct phacDiscLoop_TypeB_Tags {
        uint8_t bTotalTagsFound_B;//总共发现B卡的数量    /**< Number of Type B tags detected  */
        uint8_t bDeviceLimit_B;  //最大B卡的个数   /**< Fix the limit of number of tags to be discovered during activation  */
        uint8_t bActivatedTagNumber_B;//激活的数量，次变量
        ...
        struct phacDiscLoop_TypeB_I3P3B {
            ...
            uint8_t bTagState;  /*状态，是在工作状态还是被sleep了*/
    ...
    typedef struct phacDiscLoop_TypeF_Tags {
        ...
        uint8_t   bTotalTagsFound_F;      //发现的卡片数量，程序暂时只能发现一个C卡
        uint8_t   bActivatedTagNumber_F;  //激活的卡片数量，只能发现一个个C卡
 ...
 */
    typedef struct phacDiscLoop_Sw_DataParams {
        ...
        uint8_t                   bState;                    /*当前状态 */
        uint16_t                  wTagsFound;                /*POLL打的卡片类型，安装BIT位设置*/
        uint8_t                   bBailOut; //是否使能激活应用层/**< The bail out parameter after detecting a card type */
        ...
        phpalI14443p3a_Sw_DataParams_t  *pPal1443p3aDataParams;     /**< Pointer to the 14443P3A layer PAL data params */
        phpalI14443p4a_Sw_DataParams_t  *pPal1443p4aDataParams;     /**< Pointer to the 14443P4A layer PAL data params */
        void   *pPalFelicaDataParams;      /**< Pointer to the Felica PAL data params */
        phpalI14443p3b_Sw_DataParams_t  *pPal1443p3bDataParams;     /**< Pointer to the Type B 14443-B PAL data params */
        phpalI14443p4_Sw_DataParams_t  *pPal1443p4DataParams;
