...
//extern unsigned char SPI_RF_SendByte(unsigned char byte1);
//
//extern unsigned char SPI_RF_ReadByte(void);
...
*******************************************************************************/
//unsigned char SPI_RF_SendByte(unsigned char dt)
//{
//    {
//        unsigned char loop;
//        unsigned char i,temp=0;
//        for (i=0;i<8;i++) {
//            SPI_SCK_PIN_L(); //下降沿，发送数据
//            (dt&0x80)?SPI_MOSI_PIN_H():SPI_MOSI_PIN_L();


//            for (loop = 0; loop<8 ;loop++) ;//延时
//            dt<<=1;
//            SPI_SCK_PIN_H();//上升沿，读数据
//            temp<<=1;
//            if (SPI_MISO_PIN()==1) temp|=0x01;
//            for (loop = 0; loop<8 ;loop++) ;//延时
//        }
//        return temp;
//    }
//}
//unsigned char SPI_RF_ReadByte(void)
//{
//    return(SPI_RF_SendByte(0x00));
//}

//unsigned char SPI_RC523_Read(unsigned char SpiAddress)
//{       
//    unsigned short loop;
//    //  unsigned int 
//    unsigned  char ret;
...
//void SPI_RC523_Write(unsigned char SpiAddress,unsigned char value)
//{
//    unsigned  char ret;
//    unsigned short loop;
//    SPI_RC663_CS_LOW();
...
//    pRxLength = NULL;
    ...
    if (0 == wRxBufSize) {
...
#endif
#ifdef SPI_USED
        RC523_WriteByte(pTxBuffer[0], pTxBuffer[1]);
        status = 0;
        ...
        *pRxLength = 0;
        ...
        pRxBuffer[1] = RC523_ReadByte(pTxBuffer[0]);
        status = 0;
