...
#define PHPAL_I14443P4_SW_STATE_I_BLOCK_TX      0x01U//发送模式

/** I-Block reception mode  */
#define PHPAL_I14443P4_SW_STATE_I_BLOCK_RX      0x02U//接收模式
...
#define PHPAL_I14443P4_SW_STATE_CHAINING_BIT    0x80U//链接标识
