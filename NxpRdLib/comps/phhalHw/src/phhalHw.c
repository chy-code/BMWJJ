...
*    硬件层数据命令交换
*    ppRxBuffer:接收缓冲区
*    pRxLength：接收缓冲区的长度，如果接收的是I块链接，，pRxLength是总的长度
***************************************************************/
...
{
    return phhalHw_Rc523_WriteRegister( pDataParams,(uint8_t)(bAddress),bValue);
                               ...
                               )
{
    ...
    return phhalHw_Rc523_ReadRegister( pDataParams,(uint8_t)(bAddress),pValue);
    //  return PH_ADD_COMPCODE(PH_ERR_SUCCESS, PH_COMP_HAL);
}
