...
#define PHHAL_HW_RC663_CMD_RECEIVE              0x05U   /**< Activates the receiver circuitry.  激活接收电路 */
#define PHHAL_HW_RC663_CMD_TRANSMIT             0x06U   /**< Transmits data from the FIFO buffer to Card. *///发送缓冲区的数据，但是不激活接收电路
#define PHHAL_HW_RC663_CMD_TRANSCEIVE           0x07U   /**< Like #PHHAL_HW_RC663_CMD_TRANSMIT but automatically activates the receiver after transmission is finished. *///发送缓冲区的数据，发送完成之后，激活接收电路
...
#define PHHAL_HW_RC663_BIT_IRQINV               0x80U//清除所有的标志位
#define PHHAL_HW_RC663_BIT_HIALERTIRQ           0x40U//高益处报警
#define PHHAL_HW_RC663_BIT_LOALERTIRQ           0x20U//低益处报警
#define PHHAL_HW_RC663_BIT_IDLEIRQ              0x10U
#define PHHAL_HW_RC663_BIT_TXIRQ                0x08U//数据发送完成
#define PHHAL_HW_RC663_BIT_RXIRQ                0x04U//接收到结束位
#define PHHAL_HW_RC663_BIT_ERRIRQ               0x02U//接收到了错误
#define PHHAL_HW_RC663_BIT_EMDIRQ               0x01U//接收到SOF
/*@}*/
...
#define PHHAL_HW_RC663_BIT_PROTERR              0x02U//SOF EOF 数据位错误
#define PHHAL_HW_RC663_BIT_INTEGERR             0x01U//基检验、CRC错误
/*@}*/
...
*/
/*@{*/
#define PHHAL_HW_RC663_BIT_TSTOP_RX             0x80U   /**< 接收到就停止计数器. */
#define PHHAL_HW_RC663_BIT_TAUTORESTARTED       0x08U   /**< 自动重载. */
#define PHHAL_HW_RC663_BIT_TSTART_TX            0x10U   /**< 发送完成，启动定时器. */
