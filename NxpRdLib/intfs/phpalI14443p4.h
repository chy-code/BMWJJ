...
typedef struct
{
    ...
    //uint8_t   bBlockType;//定义上次发送块的类型

    uint8_t   bStateNow;        /**< Current Exchange-State. *///默认为 PHPAL_I14443P4_SW_STATE_I_BLOCK_TX
    ...
    uint8_t   bMaxRetryCount;   /**< Maximum Retry count for ISO/IEC 14443-4:2008(E) Rule 4 and 5.  默认为重传2次，所以一共3次 */
